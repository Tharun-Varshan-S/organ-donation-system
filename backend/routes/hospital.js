...
router.put('/requests/:id/delay-reason', protectHospital, hospitalOnly, ensureApproved, updateRequestDelayReason);
...
router.get('/emergency-summary', protectHospital, hospitalOnly, ensureApproved, getEmergencySummary);
